...
N.B. : on suppose que la batterie est ici un *price-taker*, c'est-à-dire que son action n'influe pas les prix, ce qui semble raisonnable si la batterie (ou le système de batterie) reste suffisamment petite (autour de 1 MW de puissance)
